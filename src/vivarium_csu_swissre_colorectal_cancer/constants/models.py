...
SCREENING_PRECLINICAL_STATE = "positive_preclinical_colorectal_cancer_screen"
...
SCREENING_MODEL_TRANSITIONS = (
    ...
    TransitionString(f'{SCREENING_NEGATIVE_STATE}_TO_{SCREENING_PRECLINICAL_STATE}'),
    TransitionString(f'{SCREENING_NEGATIVE_STATE}_TO_{SCREENING_POSITIVE_STATE}'),
    TransitionString(f'{SCREENING_HIGH_RISK_STATE}_TO_{SCREENING_PRECLINICAL_STATE}'),
    TransitionString(f'{SCREENING_HIGH_RISK_STATE}_TO_{SCREENING_POSITIVE_STATE}'),
    TransitionString(f'{SCREENING_PRECLINICAL_STATE}_TO_{SCREENING_POSITIVE_STATE}'),
)
...
def get_screening_cancer_model_state(cancer_model_state: str):
    return {
        ...
        PRECLINICAL_STATE: SCREENING_PRECLINICAL_STATE,
