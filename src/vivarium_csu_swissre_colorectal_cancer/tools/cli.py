...
``src/vivarium_csu_swissre_colorectal_cancer/model_specifications``.
Add location strings to the ``src/vivarium_csu_swissre_colorectal_cancer/constants/metadata.py``
...
`src/vivarium_csu_swissre_colorectal_cancer/constants/metadata.py``.
...
from vivarium_csu_swissre_colorectal_cancer.tools import (build_artifacts,
...
def make_specs(template: str, location: str, output_dir: str, verbose: int, with_debugger: bool) -> None:
    ...
    ``src/vivarium_csu_swissre_colorectal_cancer/model_specification/model_spec.in``
    """
